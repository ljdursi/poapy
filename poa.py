...
if __name__ == "__main__":
    ...
    parser.add_argument('-O', '--gapopen', type=int, default=-4, help='Gap opening score')
    parser.add_argument('-E', '--gapextend', type=int, default=-2, help='Gap extension score')
    parser.add_argument('-m', '--match', type=int, default=1, help='Match score')
    parser.add_argument('-M', '--mismatch', type=int, default=-1, help='Mismatch score')
